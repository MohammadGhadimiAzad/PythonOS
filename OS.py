...
from System.Core.Core import (
    ...
    isDesktop, isBoot, routines, GlobalObjects
)
...
def TurnOnServer(main_func = None):
    Os = GlobalObjects().os
    ...
    def start_boot():
        ...
        # After 5 seconds (or when everything is loaded), launch the desktop.
        Os.after(5000, Login, Os)
